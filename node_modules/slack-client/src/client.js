...
Client = (function(_super) {
  ...
  Client.prototype.createChannel = function(name, callback) {
      var params;
      params = {
          "name" : name
      };
      return this._apiCall('channels.create',params, (function(_this) {
          return function() {
              _this._onCreateChannel.apply(_this, arguments);
              return typeof callback === "function" ? callback.apply(null, arguments) : void 0;
          };
      })(this));
  };

  Client.prototype._onCreateChannel = function(data) {
      return this.logger.debug(data);
  }
        ...
        return res.on('end', function() {
          ...
          if (callback != null) {
            if (res.statusCode === 200) {
              ...
              var stringVal = querystring.stringify(value);
              console.log("Method " + method + " Status " + res.statusCode + " value " + stringVal);
      ...
      return function(error) {
        if (callback != null) {
          return callback({
            'ok': false,
            'error': error.errno
            //console.log("Method: " + method + ", Error: " + error.errno);
          });
        }
      };
    })(this));
